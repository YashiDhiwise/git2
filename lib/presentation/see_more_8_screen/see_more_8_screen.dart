import '../see_more_8_screen/widgets/see_more_8_item_widget.dart';
import 'controller/see_more_8_controller.dart';
import 'models/see_more_8_item_model.dart';
                      ...
                      Container(
                        ...
                        child: GridView.builder(
                          ...
                          itemCount: controller
                              .seeMore8ModelObj.value.seeMore8ItemList.length,
                          itemBuilder: (context, index) {
                            SeeMore8ItemModel model = controller
                                .seeMore8ModelObj.value.seeMore8ItemList[index];
                            return SeeMore8ItemWidget(
                              model,
                            );
                          },
                        ),
