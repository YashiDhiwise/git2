...
class Explore17ItemWidget extends StatelessWidget {
  Explore17ItemWidget(this.explore17ItemModelObj);

  Explore17ItemModel explore17ItemModelObj;
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Image.asset(
              ImageConstant.img_thumbnailimage_99,
