...
class Explore15ItemWidget extends StatelessWidget {
  Explore15ItemWidget(this.explore15ItemModelObj);

  Explore15ItemModel explore15ItemModelObj;
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Image.asset(
              ImageConstant.img_thumbnailimage_96,
