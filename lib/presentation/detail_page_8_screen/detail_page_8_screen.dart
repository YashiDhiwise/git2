import '../detail_page_8_screen/widgets/detail_page_8_item_widget.dart';
                ...
                children: [
                  Container(
                    ...
                    Padding(
                        ...
                        child: Image.asset(ImageConstant.img_backgroundblur,
                            height: getVerticalSize(188.83),
                    ...
                    Padding(
                        ...
                        child: Image.asset(ImageConstant.img_thumbnail,
                            height: getVerticalSize(133.64),
                                                                    ...
                                                                    Container(
                                                                        ...
                                                                        child: Row(
                                                                            mainAxisAlignment:
                                                                                MainAxisAlignment.center,
                                                                            children: [
                                                                              Padding(padding: EdgeInsets.only(left: getHorizontalSize(17), top: getVerticalSize(1), bottom: getVerticalSize(1)), child: SvgPicture.asset(ImageConstant.img_playicon_1, height: getHorizontalSize(14), width: getHorizontalSize(14), fit: BoxFit.cover)),
                                    ...
                                    Container(
                                        ...
                                        child: Obx(() => ListView.builder(
                                            ...
                                            itemBuilder: (context, index) {
                                              DetailPage8ItemModel model =
                                                  controller
                                                          .detailPage8ModelObj
                                                          .value
                                                          .detailPage8ItemList[
                                                      index];
                                              return DetailPage8ItemWidget(
                                                  model);
                                            })))
                                  ])))),
                  Container(
                                  ...
                                  Column(
                                      ...
                                      children: [
                                        Padding(
                                            ...
                                            child: SvgPicture.asset(
                                                ImageConstant.img_exploreicon_2,
                                                height: getHorizontalSize(22),
                                                width: getHorizontalSize(22),
                                                fit: BoxFit.cover)),
                                        Text("lbl_explore".tr,
